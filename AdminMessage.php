...
<body onload="refresher('<?php echo $email ?>');" style="background-color: #7e7f88; background-image: linear-gradient(90deg,#7e7f88  0%,#ebebed 100% );">
                                ...
                                <div class="row">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <button id="button-addon2" class="btn btn-link fs-1" onclick="sendAdminMessage('<?php echo $email ?>');">
